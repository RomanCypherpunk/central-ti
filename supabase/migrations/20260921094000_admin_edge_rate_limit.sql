...
create table public.admin_user_creation_limits (
...
begin
  ...
  insert into public.admin_user_creation_limits as limite (ator_id, janela_inicio, requisicoes)
...
$$;
revoke all on function public.consumir_limite_criacao_usuario(uuid) from public, anon, authenticated;
grant execute on function public.consumir_limite_criacao_usuario(uuid) to service_role;
